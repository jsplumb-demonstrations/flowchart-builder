 ...
 * @param shapeLibrary
 */
export default function ExportComponent({shapeLibrary}) {

    const surfaceContext = useContext(SurfaceContext)

    function exportSVG() {
        surfaceContext.listen(s => new SvgExporterUI(s, shapeLibrary).export({}))
    }
    ...
    function exportPNG() {
        ...
        surfaceContext.listen(s => new ImageExporterUI(s, shapeLibrary).export({dimensions:[
    ...
    function exportJPG() {
        ...
        surfaceContext.listen(s => new ImageExporterUI(s, shapeLibrary).export({type:"image/jpeg", width:3000}))
    }
